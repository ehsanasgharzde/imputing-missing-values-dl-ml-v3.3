...
########## Setting ExtraTreesRegressor and  IterativeImputer
etreg = ExtraTreesRegressor()
iterimp = IterativeImputer(estimator=etreg, max_iter=40, tol=1e-12, verbose=2)
...
########## Creating a csv file
micedataset.to_csv("multivariate-method-results/AMR-and-NSH-Buoy-Data1394-normalized-mice-extra-trees-regressor.csv")